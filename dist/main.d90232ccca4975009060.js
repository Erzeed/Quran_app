...
var cardData = /*#__PURE__*/function (_HTMLElement) {
  _inherits(cardData, _HTMLElement);
...
var err = /*#__PURE__*/function (_HTMLElement) {
  _inherits(err, _HTMLElement);
...
// EXTERNAL MODULE: ./src/Components/cardData.js
var cardData = __webpack_require__(841);
;// CONCATENATED MODULE: ./src/script/Api/surahAPI.js
...
var surah = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios_default().get("".concat(baseUrl, "/surah"));
  ...
  return function surah() {
    return _ref.apply(this, arguments);
  };
}();
var juz = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return axios_default().get("".concat(baseUrl, "/surah/").concat(iD));
...
var card = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(card, [{
    ...
    value: function render() {
      ...
      this._surah.forEach(function (el) {
        var cardData = document.createElement('card-data');
        cardData.surah = el;

        _this2.shadowDOM.appendChild(cardData);
      });
    }
  }]);
...
;// CONCATENATED MODULE: ./src/img/icons/play-line.png
/* harmony default export */ const play_line = (__webpack_require__.p + "40a4fc12dbfac19917e964153c745b9a.png");
;// CONCATENATED MODULE: ./src/img/icons/pause-line.png
/* harmony default export */ const pause_line = (__webpack_require__.p + "8c958467ef5a785e25499600ab7e8848.png");
// EXTERNAL MODULE: ./node_modules/howler/dist/howler.js
var howler = __webpack_require__(766);
;// CONCATENATED MODULE: ./src/Components/quran.js
function quran_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { quran_typeof = function _typeof(obj) { return typeof obj; }; } else { quran_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return quran_typeof(obj); }

function quran_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function quran_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function quran_createClass(Constructor, protoProps, staticProps) { if (protoProps) quran_defineProperties(Constructor.prototype, protoProps); if (staticProps) quran_defineProperties(Constructor, staticProps); return Constructor; }

function quran_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) quran_setPrototypeOf(subClass, superClass); }

function quran_createSuper(Derived) { var hasNativeReflectConstruct = quran_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = quran_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = quran_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return quran_possibleConstructorReturn(this, result); }; }

function quran_possibleConstructorReturn(self, call) { if (call && (quran_typeof(call) === "object" || typeof call === "function")) { return call; } return quran_assertThisInitialized(self); }

function quran_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function quran_wrapNativeSuper(Class) { var _cache = typeof Map === "function" ? new Map() : undefined; quran_wrapNativeSuper = function _wrapNativeSuper(Class) { if (Class === null || !quran_isNativeFunction(Class)) return Class; if (typeof Class !== "function") { throw new TypeError("Super expression must either be null or a function"); } if (typeof _cache !== "undefined") { if (_cache.has(Class)) return _cache.get(Class); _cache.set(Class, Wrapper); } function Wrapper() { return quran_construct(Class, arguments, quran_getPrototypeOf(this).constructor); } Wrapper.prototype = Object.create(Class.prototype, { constructor: { value: Wrapper, enumerable: false, writable: true, configurable: true } }); return quran_setPrototypeOf(Wrapper, Class); }; return quran_wrapNativeSuper(Class); }

function quran_construct(Parent, args, Class) { if (quran_isNativeReflectConstruct()) { quran_construct = Reflect.construct; } else { quran_construct = function _construct(Parent, args, Class) { var a = [null]; a.push.apply(a, args); var Constructor = Function.bind.apply(Parent, a); var instance = new Constructor(); if (Class) quran_setPrototypeOf(instance, Class.prototype); return instance; }; } return quran_construct.apply(null, arguments); }

function quran_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function quran_isNativeFunction(fn) { return Function.toString.call(fn).indexOf("[native code]") !== -1; }

function quran_setPrototypeOf(o, p) { quran_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return quran_setPrototypeOf(o, p); }

function quran_getPrototypeOf(o) { quran_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return quran_getPrototypeOf(o); }





var quran = /*#__PURE__*/function (_HTMLElement) {
  quran_inherits(quran, _HTMLElement);

  var _super = quran_createSuper(quran);

  function quran() {
    var _this;

    quran_classCallCheck(this, quran);
  ...
  quran_createClass(quran, [{
    key: "ayat",
    set: function set(ayat) {
      this._ayat = ayat;
    ...
    value: function mapping() {
      var ayat = this.shadowDOM.querySelector('.ayatt');

      this._ayatt.map(function (el) {
        var numb = el.numberInSurah;

        if (numb == 1) {
          var filterD = el.text.substring(39);
          var span = "<span class=\"surah_".concat(numb, "\">").concat(filterD, " {").concat(numb, "} </span>");

          if (filterD == '') {
            var txt = "<span class=\"surah_".concat(numb, "\">").concat(filterD, "</span>");
            ayat.innerHTML += txt;
          } else {
            ayat.innerHTML += span;
          }
        } else {
          var _txt = "<span class=\"surah_".concat(numb, "\">").concat(el.text, " {").concat(numb, "} </span>");
    ...
    value: function playList() {
      var baseAudio = "https://cdn.islamic.network/quran/audio/128/ar.alafasy";
      var playList = [];
      var lastIdSong = this._ayatt[this._ayatt.length - 1].number;

      for (var i = this._ayatt[0].number; i <= lastIdSong; i++) {
        playList.push("".concat(baseAudio, "/").concat(i, ".mp3"));
      }
    ...
    value: function playSong() {
      ...
      var b = sessionStorage.getItem('i');
      var lastIdSong = this._ayatt[this._ayatt.length - 1].number;
      var imgPause = this.shadowDOM.querySelector('button .pause');
      ...
      sound.on('play', function () {
        ...
        if (b > 0) {
          try {
            var addClassActive = _this2.shadowDOM.querySelector(".surah_".concat(b));

            var removeClassActive = _this2.shadowDOM.querySelector(".surah_".concat(i));
      ...
      sound.on('end', function () {
        i++;
        sessionStorage.setItem('i', "".concat(i));

        _this2.playSong();

        if (i == lastIdSong) {
          var removeClassActive = _this2.shadowDOM.querySelector(".surah_".concat(lastIdSong));

          removeClassActive.classList.remove('active');
          sessionStorage.clear('i');
          imgPause.src = play_line;
    ...
    key: "audioControl",
    value: function audioControl(e) {
      var target = e.target.classList;
      var img = this.shadowDOM.querySelector('button .play');
      var imgPause = this.shadowDOM.querySelector('button .pause');
      var i = sessionStorage.getItem('i');
...
var error = __webpack_require__(276);
...
var main = function main() {
  ...
  var quran = document.querySelector('quran-main');
  var banner = document.querySelector('banner-quran');
  var searchText = document.querySelector('.search input');
  var loading = document.querySelector('loading-roll');
  ...
  var showJuz = /*#__PURE__*/function () {
    var _ref2 = main_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var _data, data;
  ...
  var search = function search(data) {
    ...
    data.forEach(function (e) {
      var name = e.englishName.toLowerCase();

      if (name.includes("".concat(searchText.value))) {
        dataQuran.push(e);
      }
    });

    if (dataQuran == '') {
      alert("maaf ".concat(searchText.value, " tidak ditemukan"));
    } else {
